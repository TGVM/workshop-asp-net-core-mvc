...
using SalesWebApplicationMVC.Models.Enums;

namespace SalesWebApplicationMVC.Data
{
    public class SeedingService
    {
        private SalesWebApplicationMVCContext _context;


        public SeedingService(SalesWebApplicationMVCContext context) {
            _context = context;
        }
